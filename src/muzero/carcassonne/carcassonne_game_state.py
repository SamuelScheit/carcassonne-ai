...
from carcassonne.tile_sets.base_deck import base_tile_counts, base_tiles
...
from carcassonne.tile_sets.the_river_deck import the_river_tiles, the_river_tile_counts
...
class CarcassonneGameState:
    def __init__(self,
                 ...
                 players: int = 2,
                 board_size: (int, int) = (15, 15),
                 starting_position: Coordinate = Coordinate(7, 7)):

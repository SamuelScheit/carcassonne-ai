...
num_tiles = 20
tile_rotation = 4
meeple_positions = 6  # top, bottom, left, right, center, none

action_space = list(
    range(board_size * board_size + num_tiles + tile_rotation +
          meeple_positions))
...
class MuZeroConfig:
    def __init__(self):
        ...
        self.observation_shape = (
            ...
            num_tiles + meeple_positions + tile_rotation
        ...
        self.players = list(
            range(2))  # List of players. You should only edit the length
        ...
        self.max_moves = 72 * 3  # Maximum number of moves if game is not finished before
...
class Game(AbstractGame):
    ...
    def step(self, action):
        ...
        """
        observation, reward, done = self.env.step2(action)
    ...
    def legal_actions(self):
        ...
        """
        return ActionUtil.get_possible_actions2(self.env.state)
